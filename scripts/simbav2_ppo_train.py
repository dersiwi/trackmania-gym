...
from tmn_sb3.simbav2.normalizers import OnPolicySimbaVecNormalize
...
def main(cfg: TrainConfig, run_id: Optional[str] = None):
    ...
    if cfg.vectorized.vectorize:
        ...
        tm_env = OnPolicySimbaVecNormalize(tm_env, g_max=cfg.sb3.algorithm_params.max_v, norm_obs_keys=obs_keys)
    ...
    try:
        ...
        model = get_model_from_config(
            cfg=cfg, tm_env=tm_env, print_params=True, run_id=exp_manager.get_tensorboard_login_identifier()
        )
