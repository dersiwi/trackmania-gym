...
class ListbasedObs(ObservationManager):
    """This Observation-Manager is able to gather observations specified by a list : observation_list, dynamically. 
    According to simstate-space-dict it queries the specifeid fields from the space dict and wrapps them into an [N,] vector. No mofifications are applied."""
